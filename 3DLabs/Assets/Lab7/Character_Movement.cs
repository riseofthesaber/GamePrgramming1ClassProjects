...
public class Character_Movement : Base_Movement
{
...
*//*        Collider[] overlappedColliders = Physics.overlap(origin, (capsuleCollider.radius * 0.95f), environmentLayerMask, QueryTriggerInteraction.Ignore);
    ...
    override public void Jump()
    {
        ...
        {
            Debug.Log("jump");
            characterRigidbody.AddForce(Vector2.up * jumpForce, ForceMode.Impulse);
            // add animator here
        }
    }
    override public void JumpCanceled()
    {
        if (characterRigidbody.velocity.y > 0)
        {
            ...
            characterRigidbody.AddForce(Vector2.down * characterRigidbody.velocity.y * .5f * characterRigidbody.mass, ForceMode.Impulse);
        }
    }
